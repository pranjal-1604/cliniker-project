...
export default function EditRecords({navigation, route}) {
      ...
      <ScrollView style={styles.scrollView}>
        <View style={[styles.customHeader]}>
          <View style={[styles.headerLeft]}>
            ...
            <Text style={[styles.font, styles.headerTitle]}>EDIT RECORDS</Text>
            <Text></Text>
          </View>
        </View>
        <View style={styles.main}>
          ...
          <TouchableOpacity onPress={() => submit()} style={styles.button}>
            <Text style={styles.buttonT}>SAVE DOCUMENT</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
